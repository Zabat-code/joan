...
@section('content')
    <div class=" w-full container-users bg-white p-4 rounded-lg shadow-md flex">


        <section class="main-content-users   w-full min-h-screen">
            @yield('users_content') {{-- Yield principal para las vistas del módulo Usuarios --}}
        </section>
    </div>
@endsection
